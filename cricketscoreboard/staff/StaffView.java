...
public class StaffView implements StaffViewCallback{
    private StaffControllerViewCallback staffController;
            ...
            try {
                ...
                switch (choice){
                    case 1:
                        ...
                        break;
                    case 2:
                        staffController.getTeamsForMatch();
                        break;
                    case 3:
                        staffController.getAllTeams();
                        break;
                    case 4:
                        staffController.getAllMatches();
                    case 0:
    ...
    public void teamsFound(List<Team> teams) {
        ...
        while (true){
            try {
                ...
                staffController.getTeam(teamId);
            }catch (NumberFormatException e){
    ...
    public void showAllMatches(List<Match> matches) {
        ...
        while (true){
            try {
                ...
                staffController.getMatch(matchId);
            }catch (NumberFormatException e){
                System.out.println("Enter valid teamId");
            }
        }
    ...
    private void getMatchScores(Team team1, Team team2) {
        ...
        while (true){
            try {
                ...
                staffController.addMatch(match);
            }catch (NumberFormatException e){
